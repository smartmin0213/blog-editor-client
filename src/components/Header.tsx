    ...
    <nav className="bg-gray-600">
      <div className="max-w-7xl mx-auto flex items-center h-16 justify-between px-4 ">
        <div className="w-10 h-10 object-contain">
          <img src="https://img.freepik.com/premium-vector/checklist-complete-tasks-blog-list-survey-exam-concepts-premium-quality-modern-flat-design_189959-533.jpg?w=2000" alt="logo" />
        </div>
